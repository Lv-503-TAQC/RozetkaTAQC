...
public class ProductReviewsLocators {
    ...
    public static final String PRODUCT_REVIEW_MOST_USEFUL_HEADER = "//*[@class = 'product-comments__heading product-comments__heading_color_yellow']";
    public static final String PRODUCT_REVIEW_MOST_USEFUL_LIST = "//section/comment-list[1]/ul";
    public static final String PRODUCT_REVIEW_ALL_HEADER = "//*[@class = 'product-comments__heading']";
    public static final String PRODUCT_REVIEW_ALL_LIST = "//section/comment-list[2]/ul";
    public static final String PRODUCT_REVIEW_LINK_TO_COMMENT = "//*[@class = 'button button_type_link product-comment__link']";
