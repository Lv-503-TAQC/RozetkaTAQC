...
public class CommentPageObject extends BasePageObject {
    ...
    public Label getCommentDate() {
        commentDateLbl = new Label(element.findElement(By.xpath(COMMENT_DATE)));

        return commentDateLbl;
    }

    public Label getCommentBody() {
        commentBodyLbl = new Label(element.findElement(By.xpath(COMMENT_BODY)));

        return commentBodyLbl;
    }

    public ComplainPopupDialogPageObject complainToComment() {
        complainToCommentBtn = new Button(element.findElement(By.xpath(COMPLAIN_TO_COMMENT)));
    ...
    public ReplyPopupDialogPageObject replyToComment() {
        replyToCommentBtn = new Button(element.findElement(By.xpath(REPLY_TO_COMMENT_BUTTON)));
    ...
    public CommentPageObject likeToComment() {
        likeToCommentBtn = new Button(element.findElement(By.xpath(LIKE_COMMENT)));
    ...
    public CommentPageObject dislikeToComment() {
        dislikeToCommentBtn = new Button(element.findElement(By.xpath(DISLIKE_COMMENT)));
    ...
    public CommentPageObject goToComment() {
        goToCommentLBtn = new Button(element.findElement(By.xpath(GO_TO_COMMENT_BUTTON)));
